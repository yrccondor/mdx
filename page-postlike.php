...
$mdx_share_area=mdx_get_option('mdx_share_area');$mdx_index_img=mdx_get_option('mdx_index_img');$mdx_side_img=mdx_get_option('mdx_side_img');if($mdx_side_img==''){$mdx_side_img=$mdx_index_img;};?>
    ...
    <?php }?>
        ...
        <?php if($post_style=="0"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url=$full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_img_url="";}else{$mdx_image_url=get_bloginfo("template_url")."/img/dpic.jpg";}}?>
...
<?php get_template_part('includes/toggleposts')?>
      ...
      <?php }else if($post_style=="1"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url = $full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_img_url="";}else{$mdx_image_url=get_bloginfo("template_url")."/img/dpic.jpg";}}?>
...
<?php get_template_part('includes/toggleposts')?>
      ...
      <?php }else if($post_style=="2"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url = $full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_img_url="";}else{$mdx_image_url=get_bloginfo("template_url")."/img/dpic.jpg";}}?>
