...
<a href="<?php echo get_permalink($related_post->ID); ?>" rel="bookmark" title="<?php echo $related_post->post_title; ?>"><li class="mdui-card mdui-color-theme"><div class="mdx-lazyload lazyload"<?php $mdx_img = wp_get_attachment_image_src( get_post_thumbnail_id( $related_post->ID),'large')[0]; if($mdx_img!=""){?> data-bg="<?php echo $mdx_img.'"';}?>></div><span<?php if($mdx_img!=""){?> class="mdx-same-posts-img"<?php }?>><?php echo $related_post->post_title; ?></span><i class="mdui-icon material-icons" title="<?php _e("前往阅读","mdx");?>">&#xe5c8;</i><div class="mdx-sp-fill<?php if($mdx_img==""){?> mdx-hot-posts-have-img<?php }?>"><div></li></a>
<?php }?></ul></div></div><?php }}}elseif($mdx_way=="category"){
    ...
    if($cats){
      ...
      <?php foreach ($related as $related_post){?><a href="<?php echo get_permalink($related_post->ID); ?>" rel="bookmark" title="<?php echo $related_post->post_title; ?>"><li class="mdui-card mdui-color-theme"><div class="mdx-lazyload lazyload"<?php $mdx_img = wp_get_attachment_image_src( get_post_thumbnail_id( $related_post->ID),'large')[0]; if($mdx_img!=""){?> data-bg="<?php echo $mdx_img.'"';}?>></div><span<?php if($mdx_img!=""){?> class="mdx-same-posts-img"<?php }?>><?php echo $related_post->post_title; ?></span><i class="mdui-icon material-icons" title="<?php _e("前往阅读","mdx");?>">&#xe5c8;</i><div class="mdx-sp-fill<?php if($mdx_img==""){?> mdx-hot-posts-have-img<?php }?>"><div></li></a><?php }?></ul></div></div><?php }}}?>