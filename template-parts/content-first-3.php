...
<div class="mdui-card postDiv mdui-center mdui-hoverable">
    ...
    <div class="mdui-card-actions">
        <?php if(get_option("mdx_echo_post_sum")=="true"){ ?><p class="ct1-p mdui-text-color-black"><?php if(post_password_required()){_e('这篇文章受密码保护，输入密码才能看哦', 'mdx');}else{$summ = mdx_get_post_excerpt($post, 170);if($summ !== ""){echo $summ;}else{_e("这篇文章没有摘要");}}?><p>
