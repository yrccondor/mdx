...
<footer class="foot mdui-text-center<?php if(mdx_get_option("mdx_styles_footer") === "2"){?> mdx-footer-clean<?php }else if(mdx_get_option("mdx_styles_footer") === "3"){?>  mdx-footer-morden<?php }?>">
  ...
  <?php }else if(mdx_get_option("mdx_styles_footer") === "3"){?>
    <div class="mdx-clean-footer">
      ...
      <hr>
        Theme: MDx By <a href="https://flyhigher.top" target="_blank" class="click">AxtonYao</a><?php if(!empty(mdx_get_option('mdx_gongan_num'))){?><div class="mdx-copyright"><a href="<?php echo mdx_get_option('mdx_gongan_url');?>" rel="noopener" target="_blank" class="click"><?php echo mdx_get_option('mdx_gongan_num');?></a></div><div class="mdx-copyright">&nbsp;</div><div class="mdx-copyright"><img class="" height="21px" src="../wp-content/themes/mdx/img/social-icons/gongan-40-40.png"></div><?php }?><?php if(!empty(mdx_get_option('mdx_icp_num'))){?><div class="mdx-copyright"><a href="http://www.beian.miit.gov.cn/" rel="noopener" target="_blank" class="click"><?php echo mdx_get_option('mdx_icp_num');?></a></div><?php }?>
      </div>
  <?php }?>
</footer>
    </div>
