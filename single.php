...
$mdx_index_img=mdx_get_option('mdx_index_img');$mdx_side_img=mdx_get_option('mdx_side_img');if($mdx_side_img==''){$mdx_side_img=$mdx_index_img;};?>
    ...
    <?php if($post_style=="0"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url=$full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_image_url="";}else{$mdx_image_url=mdx_get_post_default_url();}}?>
...
<?php get_template_part('includes/toggleposts')?>
      ...
      <?php }else if($post_style=="1"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url = $full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_image_url="";}else{$mdx_image_url=mdx_get_post_default_url();}}?>
...
<?php get_template_part('includes/toggleposts')?>
      ...
      <?php }else if($post_style=="2"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url = $full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_image_url="";}else{$mdx_image_url=mdx_get_post_default_url();}}?>
...
<?php get_template_part('includes/toggleposts')?>
        <div id="indic"></div>
      <?php }else if($post_style=="3"){if($full_image_url!=false&&$full_image_url[0]!=""){$mdx_image_url = $full_image_url[0];}else{if(mdx_get_option("mdx_post_def_img")=="false"){$mdx_image_url="";}else{$mdx_image_url=mdx_get_post_default_url();}}?>
